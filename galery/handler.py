...
class GenerateImageHandler:
    ...
    def __init__(self, imgs=None, n=1, height=512, width=512,
    ...
    def initiate_processing(self, prompt, neg_prompt='', ):
        params = {
            'prompt': prompt,
        ...
        if response.status_code == 200:
            ...
            raise ValueError('Error! ' + str(response.status_code) + ' ' + response.text)
